📌 Deskripsi
Project ini merupakan implementasi sederhana algoritma sorting menggunakan bahasa Java, yang dibuat sebagai bagian dari tugas UTS Struktur Data.
Program ini mengolah data mahasiswa (nama, NIM, dan nilai), lalu mengurutkannya berdasarkan nilai dari tertinggi ke terendah (descending) menggunakan tiga metode berbeda:
- Bubble Sort
- Insertion Sort
- Selection Sort
